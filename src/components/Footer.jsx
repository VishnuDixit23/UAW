        ...
        <div style={{ display:"grid", gridTemplateColumns:"1.6fr 1fr 1fr 1.5fr", gap:32, paddingBottom:48, borderBottom:"1px solid rgba(255,255,255,0.08)" }} className="footer-grid">
          ...
          <div>
            ...
            <p style={{ fontFamily:"var(--f-body)", fontSize:"0.875rem", color:"rgba(255,255,255,0.48)", lineHeight:1.75, marginBottom:8 }}>
              Founded by <strong style={{ color:"rgba(255,255,255,0.75)" }}>Shivajee Vishen</strong>. Fed 20,000+ cows, helped 5,000+ dogs, empowered 1,200+ girls, educated 500+ students.
            </p>
