...
const PROGRAMMES = [
  ...
  { id:"mid-day-meal", title:"Mid-Day Meal Program (Human Feeding Initiative)", desc:"A humanitarian initiative providing fresh, hygienic, and nutritious meals daily to underprivileged communities to fight hunger and malnutrition.", icon:"🍛", img:"/gallery/mid-day-meal/mid1.png", stat:"10,000+", statLabel:"Meals Served" },
  ...
  { id:"womens-league", title:"Rajasthan Women's Football League", desc:"Supporting the first-ever top division senior women's football league in Rajasthan, featuring 5 teams, double-leg matches, and full accommodation, training, and kit support.", icon:"🏆", img:"/programmes/womens-league.jpg", stat:"5", statLabel:"Top Teams" },
